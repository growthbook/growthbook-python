...
setup(
    ...
    packages=find_packages(include=['growthbook', 'growthbook.*', 'growthbook_client']),
    package_data={"growthbook": ["py.typed"]},
    keywords='growthbook',
    py_modules=['growthbook', 'growthbook_client'],
    scripts=['growthbook/growthbook.py', 'growthbook/growthbook_client.py'],
    test_suite='tests',
